...
namespace PKKInfo
{
    public static class RosreestrDictionaries
    {
        public static Dictionary<string, string> UtilityDictionary = new Dictionary<string, string>()
        {
